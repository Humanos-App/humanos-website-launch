/* @ds-bundle: {"format":4,"namespace":"HumanosDesignSystem_d139d6","components":[{"name":"AgentConsole","sourcePath":"ui_kits/humanos-app/AgentConsole.jsx"},{"name":"App","sourcePath":"ui_kits/humanos-app/App.jsx"},{"name":"Dashboard","sourcePath":"ui_kits/humanos-app/Dashboard.jsx"},{"name":"Sidebar","sourcePath":"ui_kits/humanos-app/Sidebar.jsx"},{"name":"Mark","sourcePath":"ui_kits/humanos-app/primitives.jsx"},{"name":"Button","sourcePath":"ui_kits/humanos-app/primitives.jsx"},{"name":"StatusPill","sourcePath":"ui_kits/humanos-app/primitives.jsx"},{"name":"Label","sourcePath":"ui_kits/humanos-app/primitives.jsx"},{"name":"KV","sourcePath":"ui_kits/humanos-app/primitives.jsx"},{"name":"FieldRow","sourcePath":"ui_kits/humanos-app/primitives.jsx"},{"name":"Signature","sourcePath":"ui_kits/humanos-app/primitives.jsx"}],"sourceHashes":{"deck-stage.js":"f3d3d0a662c0","doc-page.js":"371bab66f42d","social/design-canvas.jsx":"5d0e39003628","ui_kits/humanos-app/AgentConsole.jsx":"0fd23517f2f2","ui_kits/humanos-app/App.jsx":"bc5849aa55f6","ui_kits/humanos-app/Dashboard.jsx":"134f40d34e47","ui_kits/humanos-app/Sidebar.jsx":"0a0ebe3ae41a","ui_kits/humanos-app/legacy-agent-console.jsx":"67dc23ae539b","ui_kits/humanos-app/legacy-app.jsx":"6a5bf2cf266a","ui_kits/humanos-app/legacy-dashboard.jsx":"5b5806518114","ui_kits/humanos-app/legacy-primitives.jsx":"9cd44130b86c","ui_kits/humanos-app/legacy-sidebar.jsx":"58ee6b4a7db7","ui_kits/humanos-app/primitives.jsx":"bc324e98fc0b"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.HumanosDesignSystem_d139d6 = window.HumanosDesignSystem_d139d6 || {});
...
// ui_kits/humanos-app/legacy-agent-console.jsx
try { (() => {
/* globals React */
const {
  useState,
...
// ---------- AgentConsole — verification sequence ----------
const AgentConsole = ({
  mandates,
  onNewMandate
}) => {
  const [cmd, setCmd] = useState('transfer €5,000 to vendor_88');
  const [lines, setLines] = useState([{
    kind: 'hint',
    text: 'Paste an agent action. Humanos will check mandates and resolve to authorized or rejected.'
  }]);
  ...
  const push = l => setLines(cur => [...cur, l]);
  const run = async () => {
    ...
    // Crude rule: if contains "transfer" and amount parseable ≤ 10000 under an active mandate, authorize.
    const amt = (cmd.match(/(\d[\d,]*)/) || [])[1]?.replace(/,/g, '');
    const num = amt ? parseInt(amt, 10) : null;
    const isTransfer = /transfer/i.test(cmd);
    const match = isTransfer && num && num <= 10000 ? mandates.find(m => m.status === 'authorized' && /transfer/i.test(m.action)) : null;
    const proofId = 'prf_' + Array.from({
      length: 26
    }, () => '0123456789ABCDEFGHJKMNPQRSTVWXYZ'[Math.floor(Math.random() * 32)]).join('');
    if (match) {
      push({
        kind: 'sys',
        text: `mandate ${match.id} matched · limit €10,000 / call`
      });
      await sleep(380);
      push({
        kind: 'sys',
        text: `subject ${match.subject} · scope ${match.scope}`
      });
      await sleep(280);
      push({
        kind: 'ok',
        text: `✔ authorized · proceed`
      });
      await sleep(220);
      push({
        kind: 'sys',
    ...
    } else if (isTransfer && num && num > 10000) {
      push({
        kind: 'sys',
        text: `amount €${num.toLocaleString()} exceeds per-call limit €10,000`
      });
      await sleep(300);
      push({
        kind: 'bad',
        text: `✖ not authorized · blocked`
      });
      await sleep(220);
      push({
        kind: 'sys',
        text: `proof ${proofId} (rejection)`
      });
    } else {
      push({
        kind: 'sys',
        text: 'no matching mandate for this action'
      });
      await sleep(260);
      push({
        kind: 'bad',
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement(Label, null, "Agent verification"), /*#__PURE__*/React.createElement("h1", {
    style: {
      fontSize: 36,
      fontWeight: 600,
  ...
  }, "Is this action allowed right now?"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 17,
      color: 'var(--hm-ink-2)',
      marginTop: 14,
  ...
  }, "The same check every system or agent performs before execution. One question, two answers \u2014 and every answer emits a Proof you can verify forever."), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 36,
      background: '#111',
      borderRadius: 4,
  ...
  }, "humanos \xB7 verify")), /*#__PURE__*/React.createElement("div", {
    ref: logRef,
    style: {
    ...
    if (l.kind === 'hint') return /*#__PURE__*/React.createElement("div", {
      key: i,
      style: {
        color: '#8F8D85'
      }
    }, l.text);
    if (l.kind === 'in') return /*#__PURE__*/React.createElement("div", {
      key: i
    }, /*#__PURE__*/React.createElement("span", {
      style: {
        color: '#8F8D85'
      }
    }, "agent \u203A\xA0"), /*#__PURE__*/React.createElement("span", {
      style: {
        color: '#F4F3EF'
      }
    }, l.text));
    if (l.kind === 'sys') return /*#__PURE__*/React.createElement("div", {
      key: i
    }, /*#__PURE__*/React.createElement("span", {
      style: {
        color: '#8F8D85'
      }
    }, "humanos \u203A\xA0"), /*#__PURE__*/React.createElement("span", {
      style: {
        color: l.color || '#CFCDC6'
      }
    }, l.text));
    if (l.kind === 'ok') return /*#__PURE__*/React.createElement("div", {
      key: i,
      style: {
        color: '#9C9AFF',
        fontWeight: 600
    ...
    if (l.kind === 'bad') return /*#__PURE__*/React.createElement("div", {
      key: i,
      style: {
        color: '#F3797E',
        fontWeight: 600
  ...
  }, "agent \u203A"), /*#__PURE__*/React.createElement("input", {
    value: cmd,
    ...
    style: {
      ...
      padding: '7px 14px',
      borderRadius: 2,
      background: busy ? '#2A2A28' : '#4B49CA',
      color: '#fff',
      border: 'none',
      cursor: busy ? 'wait' : 'pointer'
    }
  }, busy ? 'checking…' : 'Verify'))), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 28,
      display: 'flex',
      gap: 10,
  ...
  }, ['transfer €5,000 to vendor_88', 'transfer €25,000 to vendor_88', 'approve trade BTC-EUR 2.4'].map(q => /*#__PURE__*/React.createElement("button", {
    key: q,
    onClick: () => {
      setCmd(q);
    },
...
// ---------- IssueMandate — human layer ----------
const IssueMandate = ({
  onIssue
}) => {
  const [subject, setSubject] = useState('acct_01HQZK3N2P');
  const [action, setAction] = useState('Transfer funds');
  const [scope, setScope] = useState('treasury.vendor_payments');
  const [perCall, setPerCall] = useState('€10,000');
  const [daily, setDaily] = useState('€50,000');
  const [valid, setValid] = useState('2026-06-01');
  const [signed, setSigned] = useState(false);
  const issue = () => {
    setSigned(true);
    const id = '0x' + Array.from({
      length: 4
    }, () => Math.floor(Math.random() * 65536).toString(16).padStart(4, '0').toUpperCase()).join('') + '…' + Math.floor(Math.random() * 65536).toString(16).padStart(4, '0').toUpperCase();
    setTimeout(() => onIssue({
      id,
      status: 'authorized',
      action,
      actionCode: 'transfer_funds',
      subject,
      scope,
      perCall: `${perCall} / call`,
      daily: `${daily} / day`,
      counterparty: 'vendor_88',
      signedBy: 'Elena Ruiz',
      signedAt: new Date().toISOString().slice(0, 16).replace('T', ' ') + 'Z',
      validUntil: valid,
      anchored: 'pending',
      activity: [{
        time: new Date().toISOString().slice(0, 16).replace('T', ' ') + 'Z',
        text: 'mandate signed by Elena Ruiz'
      }, {
        time: new Date().toISOString().slice(0, 16).replace('T', ' ') + 'Z',
        text: 'queued for anchoring',
        color: '#5F7BC4'
      }]
    }), 900);
  };
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement(Label, null, "Human layer"), /*#__PURE__*/React.createElement("h1", {
    style: {
      fontSize: 44,
      fontWeight: 600,
  ...
  }, "I authorize this", /*#__PURE__*/React.createElement("br", null), "action."), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 17,
      color: '#4A4A46',
      marginTop: 18,
  ...
  }, "Your signature becomes a mandate: a structured, machine-readable authorization that any system can verify before acting on your behalf."), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 40,
      display: 'flex',
      alignItems: 'center',
    ...
    variant: "primary",
    onClick: issue
  }, "Sign & issue mandate") : /*#__PURE__*/React.createElement("span", {
    style: {
      display: 'inline-flex',
      alignItems: 'center',
      gap: 10,
  ...
  }, "\u2714"), " Signed \xB7 anchoring\u2026"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: 'var(--font-mono)',
      fontSize: 12,
      color: '#76746D'
    }
  }, "Elena Ruiz \xB7 Paris \xB7 ", new Date().toISOString().slice(0, 10)))), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: '1 1 50%',
      padding: '56px 56px',
      minHeight: 600,
      ...
      flexDirection: 'column',
      justifyContent: 'center',
      borderLeft: '1px solid var(--hm-line)'
    }
  }, /*#__PURE__*/React.createElement(Label, null, "Machine layer \xB7 draft mandate"), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 20,
      display: 'flex',
      flexDirection: 'column',
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/humanos-app/legacy-agent-console.jsx", error: String((e && e.message) || e) }); }

// ui_kits/humanos-app/legacy-app.jsx
try { (() => {
...
const initialMandates = [{
  id: '0xA13F…9C44',
  status: 'authorized',
  action: 'Transfer funds · €10,000 / call',
  actionCode: 'transfer_funds',
  subject: 'acct_01HQZK3N2P',
  scope: 'treasury.vendor_payments',
  perCall: '€10,000 / call',
  daily: '€50,000 / day',
  counterparty: 'vendor_88',
  signedBy: 'Elena Ruiz',
  signedAt: '2026-04-21 14:22Z',
  validUntil: '2026-06-01',
  anchored: '2026-04-21 14:23Z',
  activity: [{
    time: '2026-04-21 14:22Z',
    text: 'mandate signed by Elena Ruiz'
  }, {
    time: '2026-04-21 14:23Z',
    text: 'anchored to ledger',
    color: '#4B49CA'
  }, {
    time: '2026-04-22 09:04Z',
    text: 'verified for transfer €5,000 → vendor_88',
    color: '#4B49CA'
  }]
}, {
  id: '0xB720…4E11',
  status: 'executing',
  action: 'Approve trade · BTC-EUR · notional ≤ 50,000',
  actionCode: 'execute_trade',
  subject: 'acct_01HQZK3N2P',
  scope: 'trading.spot',
  perCall: 'notional ≤ €50,000',
  daily: '€500,000 / day',
  counterparty: 'desk_nyc',
  signedBy: 'Elena Ruiz',
  signedAt: '2026-04-20 08:10Z',
  validUntil: '2026-05-15',
  anchored: '2026-04-20 08:11Z',
  activity: [{
    time: '2026-04-20 08:10Z',
    text: 'mandate signed'
  }, {
    time: '2026-04-21 14:40Z',
  ...
  id: '0x5CE2…77A0',
  status: 'pending',
  action: 'Disburse payroll · April batch',
  actionCode: 'payroll_disburse',
  subject: 'acct_02PAYROLL',
  scope: 'payroll.monthly',
  perCall: '€340,000 total',
  daily: '—',
  counterparty: 'bank_eu',
  signedBy: 'Elena Ruiz',
  signedAt: '—',
  validUntil: '2026-04-28',
  anchored: '—',
  activity: [{
    time: '2026-04-21 10:05Z',
    text: 'draft created',
    color: '#5F7BC4'
  }, {
    time: '2026-04-21 10:06Z',
    text: 'awaiting second signer',
    color: '#5F7BC4'
  }]
}, {
  id: '0xD091…12FF',
  status: 'rejected',
  action: 'Grant API write · partner_x',
  actionCode: 'grant_api_scope',
  subject: 'acct_01HQZK3N2P',
  scope: 'api.write.partners',
  perCall: '—',
  daily: '—',
  counterparty: 'partner_x',
  signedBy: 'Elena Ruiz',
  signedAt: '2026-04-18 17:00Z',
  validUntil: '—',
  anchored: '—',
  activity: [{
    time: '2026-04-18 17:00Z',
    text: 'mandate requested'
  }, {
    time: '2026-04-18 17:02Z',
    text: 'rejected · scope exceeds operator role',
    color: '#F3797E'
  }]
}, {
  id: '0x3F1A…0088',
  status: 'authorized',
  action: 'Read-only finance export',
  actionCode: 'export_ledger',
  subject: 'agent_ops_01',
  scope: 'finance.read',
  perCall: '—',
  daily: '50 requests / day',
  counterparty: 'analytics_01',
  signedBy: 'Elena Ruiz',
  signedAt: '2026-04-15 09:30Z',
  validUntil: '2026-07-15',
  anchored: '2026-04-15 09:31Z',
  activity: [{
    time: '2026-04-15 09:30Z',
    text: 'mandate signed'
  }, {
    time: '2026-04-15 09:31Z',
    text: 'anchored to ledger',
    color: '#4B49CA'
  }]
}];
const App = () => {
  ...
  const [selected, setSelected] = useState(initialMandates[0].id);
  const current = mandates.find(m => m.id === selected);
  const revoke = () => {
    setMandates(ms => ms.map(m => m.id === selected ? {
      ...m,
      status: 'revoked',
      activity: [...m.activity, {
        time: new Date().toISOString().slice(0, 16).replace('T', ' ') + 'Z',
  ...
  }, view === 'dashboard' && /*#__PURE__*/React.createElement(Dashboard, null), view === 'mandates' && /*#__PURE__*/React.createElement(MandateDetail, {
    m: current,
    onRevoke: revoke
  }), view === 'agent' && /*#__PURE__*/React.createElement(AgentConsole, {
    mandates: mandates,
    onNewMandate: onIssue
  }), view === 'issue' && /*#__PURE__*/React.createElement(IssueMandate, {
    onIssue: onIssue
  })));
};
ReactDOM.createRoot(document.getElementById('root')).render(/*#__PURE__*/React.createElement(App, null));
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/humanos-app/legacy-app.jsx", error: String((e && e.message) || e) }); }

// ui_kits/humanos-app/legacy-dashboard.jsx
try { (() => {
/* globals React */
const {
  useMemo
...
// ---------- Primitives: grayscale-first chart components ----------
// Rule: grayscale by default. Signal colors ONLY where plotting authorization state.
...
// ---------- Activity over time — stacked/overlay line chart ----------
// Plots: Approved verifications, Rejected verifications, Proofs, Mandates created, Policies signed.
// Approved/Rejected use signal colors (Authorization state). Others are grayscale.
...
const ActivityChart = () => {
  ...
  const data = useMemo(() => {
    ...
    for (let i = 0; i < days; i++) {
      const base = 40 + Math.sin(i / 4) * 10 + i * 1.2;
      out.push({
        approved: Math.round(base + r() * 18),
        rejected: Math.round(6 + r() * 8 + (i > 20 ? 4 : 0)),
        proofs: Math.round(base + r() * 18 + 8),
        mandates: Math.round(2 + r() * 4),
        policies: Math.round(1 + r() * 3)
      });
    }
    return out;
  }, []);
  const W = 760,
    ...
    PAD_T = 12,
    PAD_B = 26;
  const maxY = Math.max(...data.flatMap(d => [d.approved, d.rejected, d.proofs, d.mandates, d.policies])) * 1.1;
  const x = i => PAD_L + i / (days - 1) * (W - PAD_L - PAD_R);
  ...
  return /*#__PURE__*/React.createElement(ChartCard, {
    ...
    style: {
      ...
      borderTop: s.dash ? `1.5px dashed ${s.color}` : 'none'
    }
    ...
    y2: H - PAD_B,
    stroke: INK_3
  }), series.slice().reverse().map(s => /*#__PURE__*/React.createElement("path", {
    key: s.k,
    d: path(s.k),
    fill: "none",
    stroke: s.color,
    ...
    strokeLinecap: "round"
  })), [0, 7, 14, 21, 29].map(i => /*#__PURE__*/React.createElement("text", {
    key: i,
    x: x(i),
    y: H - 8,
    fontFamily: "var(--font-mono)",
...
// ---------- Donut: Request type distribution ----------
// Five slices: e-Sign, Form, Consent, Payment, Policy
// Grayscale by default (not authorization state → no signal color).

const RequestTypeDonut = () => {
  const slices = [{
    label: 'e-Sign',
    value: 38,
    color: '#2A2A28'
...
// ---------- Donut: Approved vs Denied verifications ----------
// This IS authorization state → use signal colors.
...
const Donut = ({
  ...
  const arcs = slices.map((s, i) => {
    ...
    const d = `M${p0[0].toFixed(2)},${p0[1].toFixed(2)} A${R},${R} 0 ${large} 1 ${p1[0].toFixed(2)},${p1[1].toFixed(2)} L${p2[0].toFixed(2)},${p2[1].toFixed(2)} A${r},${r} 0 ${large} 0 ${p3[0].toFixed(2)},${p3[1].toFixed(2)} Z`;
    return {
      ...s,
      d,
      frac
  ...
  }, centerCap.toUpperCase())), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      display: 'flex',
      flexDirection: 'column',
  ...
  }, percent ? `${a.value.toFixed(1)}%` : `${(a.frac * 100).toFixed(1)}%`))))));
};

// ---------- Recent activity table ----------
const RecentActivityTable = () => {
  const rows = [{
    t: '2026-04-22 14:22:08Z',
    kind: 'verify',
    result: 'authorized',
    text: 'transfer €5,000 → vendor_88',
    mandate: '0xA13F…9C44',
    proof: 'prf_01HQZM5T9VXD4P2RA8KBNFCJ'
  }, {
    t: '2026-04-22 14:18:44Z',
    kind: 'verify',
    result: 'rejected',
    text: 'transfer €25,000 → vendor_88',
    mandate: '0xA13F…9C44',
    proof: 'prf_01HQZM4XG2TKQY9EN0WPBHR'
  }, {
    t: '2026-04-22 13:51:02Z',
    kind: 'mandate',
    result: 'signed',
    text: 'Read-only finance export',
    mandate: '0x3F1A…0088',
    proof: 'prf_01HQZM0AJ4V8K6YHCE7T3QG'
  }, {
    t: '2026-04-22 13:04:55Z',
    kind: 'policy',
    result: 'signed',
    text: 'Treasury vendor payments v2',
    mandate: '0x8B72…A404',
    proof: 'prf_01HQZL8RDE1Y2KFJ5VTW6XS'
  }, {
    t: '2026-04-22 12:40:19Z',
    kind: 'verify',
    result: 'authorized',
    text: 'execute trade BTC-EUR 2.4',
    mandate: '0xB720…4E11',
    proof: 'prf_01HQZL2WQX0YKA4G7HNRCPE'
  }, {
    t: '2026-04-22 11:03:02Z',
    kind: 'mandate',
    result: 'revoked',
    text: 'Grant API write · partner_x',
    mandate: '0xD091…12FF',
    proof: 'prf_01HQZK7GMVP2X5RBDEF4TAJ'
  }, {
    t: '2026-04-22 09:21:47Z',
    kind: 'verify',
    result: 'authorized',
    text: 'export ledger · april batch',
    mandate: '0x3F1A…0088',
    proof: 'prf_01HQZJ3KNB9YZCEPHRVW8MS'
  }];
  const pill = result => {
    const map = {
      authorized: {
        c: INDIGO,
        bg: 'rgba(75,73,202,0.10)',
        t: 'authorized'
      },
      rejected: {
        c: CORAL,
        bg: 'rgba(243,121,126,0.12)',
        t: 'rejected'
      },
      signed: {
        c: INK_1,
      ...
      revoked: {
        c: INK_2,
        bg: 'rgba(74,74,70,0.08)',
        t: 'revoked'
      }
    };
    const m = map[result] || map.signed;
  ...
  const kindBadge = k => /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: 'var(--font-mono)',
      fontSize: 11,
      color: INK_3,
  ...
  return /*#__PURE__*/React.createElement(ChartCard, {
  ...
  }, /*#__PURE__*/React.createElement(Th, null, "Time"), /*#__PURE__*/React.createElement(Th, null, "Kind"), /*#__PURE__*/React.createElement(Th, null, "Result"), /*#__PURE__*/React.createElement(Th, null, "Detail"), /*#__PURE__*/React.createElement(Th, null, "Mandate"), /*#__PURE__*/React.createElement(Th, null, "Proof"))), /*#__PURE__*/React.createElement("tbody", null, rows.map((r, i) => /*#__PURE__*/React.createElement("tr", {
    key: i,
    style: {
      borderBottom: `1px dashed ${LINE}`
    }
    ...
    mono: true
  }, r.t), /*#__PURE__*/React.createElement(Td, null, kindBadge(r.kind)), /*#__PURE__*/React.createElement(Td, null, pill(r.result)), /*#__PURE__*/React.createElement(Td, null, r.text), /*#__PURE__*/React.createElement(Td, {
    mono: true,
    muted: true
  }, r.mandate), /*#__PURE__*/React.createElement(Td, {
    mono: true,
    muted: true
  }, r.proof.slice(0, 20), "\u2026")))))));
};
...
}, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Label, null, label), /*#__PURE__*/React.createElement("div", {
  style: {
    fontSize: 19,
    fontWeight: 600,
    letterSpacing: '-0.01em',
...
const KPIStrip = () => {
  ...
  }, k.v), k.d && /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: 'var(--font-mono)',
      fontSize: 11,
      color: k.up === true ? INDIGO : k.up === false ? CORAL : INK_3,
      marginTop: 6
    }
...
}, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Label, null, "Overview"), /*#__PURE__*/React.createElement("h1", {
  style: {
    fontSize: 36,
    fontWeight: 600,
    letterSpacing: '-0.015em',
...
}, "Every verification, mandate, and proof in the last 30 days. Grayscale for volume, signal colors for authorization state.")), /*#__PURE__*/React.createElement("div", {
  style: {
    fontFamily: 'var(--font-mono)',
    fontSize: 12,
    color: INK_3
  }
}, "range \xB7 last 30 days")), /*#__PURE__*/React.createElement(KPIStrip, null), /*#__PURE__*/React.createElement("div", {
  style: {
    marginTop: 24
  }
}, /*#__PURE__*/React.createElement(ActivityChart, null)), /*#__PURE__*/React.createElement("div", {
  style: {
    display: 'grid',
    gridTemplateColumns: '1fr 1fr',
    gap: 24,
...
}, /*#__PURE__*/React.createElement(RequestTypeDonut, null), /*#__PURE__*/React.createElement(ApprovalDonut, null)), /*#__PURE__*/React.createElement("div", {
  style: {
    marginTop: 24
  }
}, /*#__PURE__*/React.createElement(RecentActivityTable, null)));
Object.assign(window, {
  Dashboard,
  ActivityChart,
  RequestTypeDonut,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/humanos-app/legacy-dashboard.jsx", error: String((e && e.message) || e) }); }

// ui_kits/humanos-app/legacy-primitives.jsx
try { (() => {
...
// ---------- Mark (three bars — canonical Humanos glyph) ----------
const Mark = ({
  size = 16,
  color = "currentColor"
}) => /*#__PURE__*/React.createElement("svg", {
...
const StatusPill = ({
  ...
  const cfg = {
    ...
    executing: {
      fg: '#7978E9',
      bg: 'rgba(121,120,233,0.12)',
      dot: true,
      label: 'Executing'
    },
    pending: {
      fg: '#5F7BC4',
      bg: 'rgba(125,160,250,0.14)',
      dot: '#7DA0FA',
      label: 'Pending'
    },
    rejected: {
  ...
  }, cfg.mark ? /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 12,
      lineHeight: 1
    }
  }, cfg.mark) : cfg.dot ? /*#__PURE__*/React.createElement("span", {
    style: {
      width: 6,
      height: 6,
      borderRadius: '50%',
      background: cfg.dot === true ? cfg.fg : cfg.dot
    }
  }) : null, cfg.label);
};
...
}, "Verified by Humanos"), id ? /*#__PURE__*/React.createElement("span", {
  style: {
    fontFamily: 'var(--font-mono)',
    fontSize: 11,
    color: 'var(--hm-ink-3)'
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/humanos-app/legacy-primitives.jsx", error: String((e && e.message) || e) }); }

// ui_kits/humanos-app/legacy-sidebar.jsx
try { (() => {
/* globals React */
const {
  useState,
...
const Sidebar = ({
...
}, "Humanos"), /*#__PURE__*/React.createElement("span", {
  style: {
    flex: 1
  }
}), /*#__PURE__*/React.createElement("span", {
...
}, [['dashboard', 'Dashboard'], ['mandates', 'Mandates'], ['issue', 'Issue mandate'], ['agent', 'Agent verification']].map(([k, l]) => /*#__PURE__*/React.createElement("button", {
  key: k,
  onClick: () => onView(k),
  style: {
    display: 'flex',
    ...
    textAlign: 'left',
    letterSpacing: '-0.005em',
    boxShadow: view === k ? '0 1px 0 var(--hm-line), 0 0 0 1px rgba(17,17,17,0.03)' : 'none'
  }
}, l))), /*#__PURE__*/React.createElement("div", {
  style: {
    padding: '16px 20px 8px'
  }
}, /*#__PURE__*/React.createElement(Label, null, "Recent mandates")), /*#__PURE__*/React.createElement("div", {
  style: {
    overflow: 'auto',
    flex: 1,
    padding: '0 8px 12px'
  }
}, mandates.map(m => /*#__PURE__*/React.createElement("button", {
  key: m.id,
  onClick: () => {
    onView('mandates');
    onSelect(m.id);
  ...
  style: {
    ...
    border: 'none',
    cursor: 'pointer',
    background: selected === m.id && view === 'mandates' ? '#fff' : 'transparent',
    padding: '12px',
    borderRadius: 2,
    marginBottom: 2,
    boxShadow: selected === m.id && view === 'mandates' ? '0 1px 0 var(--hm-line)' : 'none'
  }
}, /*#__PURE__*/React.createElement("div", {
  style: {
    display: 'flex',
...
}, "operator \xB7 elena@humanos.tech"));
...
const MandateDetail = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement(Label, null, "Mandate"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: 'var(--font-mono)',
      fontSize: 12,
      color: 'var(--hm-ink-2)'
  ...
  }, m.action), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 17,
      color: 'var(--hm-ink-2)',
      marginTop: 12,
  ...
  }, "Signed by ", m.signedBy, " on ", /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: 'var(--font-mono)',
      fontSize: 15
    }
  }, m.signedAt), ", valid until ", /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: 'var(--font-mono)',
      fontSize: 15
    }
  }, m.validUntil), "."), /*#__PURE__*/React.createElement("section", {
    style: {
      marginTop: 40,
      background: '#fff',
      border: '1px solid var(--hm-line)',
  ...
  }, /*#__PURE__*/React.createElement(Label, null, "Record"), /*#__PURE__*/React.createElement(Signature, {
    id: m.id
  })), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '22px 22px',
  ...
  }, m.activity.map((a, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      display: 'flex',
      gap: 14,
      padding: '4px 0',
      borderBottom: i < m.activity.length - 1 ? '1px dashed var(--hm-line)' : 'none'
    }
  }, /*#__PURE__*/React.createElement("span", {
    style: {
      color: 'var(--hm-ink-3)',
    ...
    variant: "secondary"
  }, "Export receipt"), /*#__PURE__*/React.createElement(Button, {
    variant: "danger",
    onClick: onRevoke,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/humanos-app/legacy-sidebar.jsx", error: String((e && e.message) || e) }); }

// ui_kits/humanos-app/primitives.jsx
try { (() => {
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
function Mark({
  size = 16,
...
function Signature({
  ...
  }, "Assessed by Humanos"), id ? /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: 'var(--font-mono)',
      fontSize: 11,
      color: 'var(--hm-ink-3)'
...
Object.assign(__ds_scope, { Mark, Button, StatusPill, Label, KV, FieldRow, Signature });
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/humanos-app/primitives.jsx", error: String((e && e.message) || e) }); }

// ui_kits/humanos-app/AgentConsole.jsx
try { (() => {
const {
  useState,
  useEffect,
...
function AgentConsole({
  ...
  const [lines, setLines] = useState([{
    kind: 'hint',
    text: 'Paste an agent action. Humanos will verify it against every Risk Intelligence Output and resolve to ALLOW or DENY.'
  }]);
  const [busy, setBusy] = useState(false);
  const logRef = useRef(null);
  useEffect(() => {
  ...
  const run = async () => {
    ...
    push({
      kind: 'sys',
      text: 'verifying against network…',
      color: '#5F7BC4'
    });
    await sleep(520);
    const amt = (cmd.match(/(\d[\d,]*)/) || [])[1]?.replace(/,/g, '');
    ...
    if (match) {
      push({
        kind: 'sys',
        text: `identity verified · policy ${match.id} matched · limit €10,000 / call`
      });
      await sleep(380);
      push({
        kind: 'sys',
      ...
      push({
        kind: 'sys',
        text: 'no matching policy for this action'
      });
      await sleep(260);
      push({
        kind: 'bad',
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement(__ds_scope.Label, null, "Risk API"), /*#__PURE__*/React.createElement("h1", {
    style: {
      fontSize: 36,
      fontWeight: 600,
      letterSpacing: '-0.015em',
  ...
  }, "Is this AI action within bounds, right now?"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 17,
      color: 'var(--hm-ink-2)',
      marginTop: 14,
  ...
  }, "The same check the Risk Network runs before execution. One call, Risk Controls checked, one Decision. Every Decision emits a Runtime Trust Proof."), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 36,
      background: '#111',
      borderRadius: 4,
  ...
  }, "POST /risk")), /*#__PURE__*/React.createElement("div", {
    ref: logRef,
    style: {
      padding: '20px 20px 10px',
      fontFamily: 'var(--font-mono)',
    ...
    }, "network \u203A\xA0"), /*#__PURE__*/React.createElement("span", {
      style: {
        color: l.color || '#CFCDC6'
      }
    }, l.text));
  ...
  }, busy ? 'verifying…' : 'Verify'))), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 28,
      display: 'flex',
      gap: 10,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/humanos-app/AgentConsole.jsx", error: String((e && e.message) || e) }); }

// ui_kits/humanos-app/Dashboard.jsx
try { (() => {
const {
  useMemo
} = React;
...
}, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(__ds_scope.Label, null, label), /*#__PURE__*/React.createElement("div", {
  style: {
    fontSize: 19,
    fontWeight: 600,
    letterSpacing: '-0.01em',
...
function Dashboard() {
  ...
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(__ds_scope.Label, null, "Overview"), /*#__PURE__*/React.createElement("h1", {
    style: {
      fontSize: 36,
      fontWeight: 600,
      letterSpacing: '-0.015em',
  ...
  }, "Every verification, mandate, and proof in the last 30 days. Grayscale for volume, signal colors for the runtime result.")), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: 'var(--font-mono)',
      fontSize: 12,
      color: INK_3
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/humanos-app/Dashboard.jsx", error: String((e && e.message) || e) }); }

// ui_kits/humanos-app/Sidebar.jsx
try { (() => {
function Sidebar({
  mandates = [],
  selected,
  ...
  }, /*#__PURE__*/React.createElement(__ds_scope.Label, null, "Recent mandates")), /*#__PURE__*/React.createElement("div", {
    style: {
      overflow: 'auto',
      flex: 1,
      padding: '0 8px 12px'
  ...
  }, m.id), /*#__PURE__*/React.createElement(__ds_scope.StatusPill, {
    status: m.status
  })), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13.5,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/humanos-app/Sidebar.jsx", error: String((e && e.message) || e) }); }

// ui_kits/humanos-app/App.jsx
try { (() => {
const {
  useState
} = React;
const initialMandates = [{
  ...
  activity: [{
    ...
    time: '2026-04-22 09:04Z',
    text: 'verified · ALLOW · transfer €5,000 → vendor_88',
    color: '#4B49CA'
  }]
}, {
  id: '0xB720…4E11',
  ...
  activity: [{
    ...
    time: '2026-04-18 17:02Z',
    text: 'denied · scope exceeds operator role',
    color: '#F3797E'
  }]
}, {
  id: '0x3F1A…0088',
...
function MandateDetail({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement(__ds_scope.Label, null, "Mandate"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: 'var(--font-mono)',
      fontSize: 12,
      color: 'var(--hm-ink-2)'
  ...
  }, /*#__PURE__*/React.createElement(__ds_scope.Label, null, "Record"), /*#__PURE__*/React.createElement(__ds_scope.Signature, {
    id: m.id
  })), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '22px 22px',
  ...
  }, /*#__PURE__*/React.createElement(__ds_scope.KV, {
    k: "Subject",
    v: m.subject
  }), /*#__PURE__*/React.createElement(__ds_scope.KV, {
    k: "Action",
    ...
    variant: "secondary"
  }, "Export receipt"), /*#__PURE__*/React.createElement(__ds_scope.Button, {
    variant: "danger",
    onClick: onRevoke,
    disabled: m.status === 'revoked'
  }, "Revoke mandate")));
...
function IssueMandate({
  ...
  }, /*#__PURE__*/React.createElement(__ds_scope.Label, null, "Verified identity"), /*#__PURE__*/React.createElement("h1", {
    style: {
      fontSize: 44,
      fontWeight: 600,
      letterSpacing: '-0.02em',
  ...
  }, "Your signature becomes one Risk Intelligence Output in the network: a structured, machine-readable delegation that any system can verify before acting on your behalf."), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 40,
      display: 'flex',
      alignItems: 'center',
  ...
  }, !signed ? /*#__PURE__*/React.createElement(__ds_scope.Button, {
    variant: "primary",
    onClick: issue
  }, "Sign & issue mandate") : /*#__PURE__*/React.createElement("span", {
    style: {
  ...
  }, /*#__PURE__*/React.createElement(__ds_scope.Label, null, "Machine layer \xB7 draft mandate"), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 20,
      display: 'flex',
      flexDirection: 'column',
  ...
  }, /*#__PURE__*/React.createElement(__ds_scope.FieldRow, {
    label: "Subject",
    value: subject,
    onChange: setSubject,
    mono: true
...
function App() {
  ...
  }, view === 'dashboard' && /*#__PURE__*/React.createElement(__ds_scope.Dashboard, null), view === 'mandates' && /*#__PURE__*/React.createElement(MandateDetail, {
    m: current,
    onRevoke: revoke
  }), view === 'agent' && /*#__PURE__*/React.createElement(__ds_scope.AgentConsole, {
    mandates: mandates
  }), view === 'issue' && /*#__PURE__*/React.createElement(IssueMandate, {
    onIssue: onIssue
  })));
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/humanos-app/App.jsx", error: String((e && e.message) || e) }); }
