...
export const metadata: Metadata = {
  ...
  description:
    "How Humanos (Unicorn Dimension, Lda) collects, uses, shares and protects personal data in compliance with GDPR and Portuguese data protection law.",
      ...
      <div className="wrap">
        <div className="legal__inner">
          ...
          <p className="legal__lede">
            ...
            <strong>Unicorn Dimension, Lda</strong>. This Privacy Statement
            explains how we collect, use, share and protect personal data
            when you use the Humanos platform, websites, applications and
            related services.
          </p>
          ...
          <p>
            ...
            protects personal data when you use the Humanos digital identity
            and verifiable credentials platform, our websites, applications
            and related services (together, the &ldquo;Service&rdquo;).
          </p>
          <p>
            We are committed to protecting the privacy of personal
            information and to compliance with applicable data protection
            laws, including the EU General Data Protection Regulation
            (Regulation (EU) 2016/679, &ldquo;GDPR&rdquo;) and Portuguese
            data protection law. Our practices are governed by our internal
            Data Protection Policy, Privacy By Design Policy, Data
            Classification Policy and Data Retention Policy, and our
            information security controls are certified to ISO/IEC
            27001:2022.
          </p>
          <p>
          ...
          <p>
            For the personal data processed in connection with the Service,
          ...
          <p>
            ...
            customer (for example, when a customer uses our platform to
            verify the identity of its own users), Humanos acts as a{" "}
            <strong>data processor</strong> and the business customer is the{" "}
            <strong>data controller</strong>. In those cases, processing is
            governed by the Data Processing Agreement (DPA) entered into
            with that customer.
          </p>
          ...
          <table className="legal__table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  Login credentials, authentication tokens, session
                  information
                </td>
              ...
              <tr>
                ...
                <td>Provided by you; processed via our verification provider</td>
              </tr>
              <tr>
                <td>
              ...
              <tr>
                ...
                <td>
                  Operational logs and security events (personal identifiers
                  are scrubbed before these logs are stored)
                </td>
          ...
          <p>
            ...
            identified or identifiable individual. Identity documents and
            facial images are <strong>special category / sensitive data</strong>{" "}
            and are subject to additional safeguards.
          </p>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  obligation; explicit consent for biometric/identity data
                  where required (Art. 9(2)(a))
                </td>
              </tr>
              <tr>
          ...
          <p>
            ...
            necessary; kept accurate and up to date; and retained only as
            long as necessary.
          </p>
          ...
          <p>
            ...
            vetted third-party subprocessors that help us deliver the
            Service, under contractual data protection terms (DPAs) and on a
            scoped, least-privilege basis. Our current subprocessors are:
          </p>
          <table className="legal__table">
            <thead>
              <tr>
          ...
          <p>
            We may also disclose personal data to authorities or third
            parties where required by law, to enforce our agreements, or to
            protect the rights, safety and security of Humanos, our users or
            the public.
          </p>
          ...
          <ul className="legal__list">
            <li>
              <strong>Stripe</strong> (United States) — operates under a PCI
              DSS Level 1 compliant channel.
            </li>
            <li>
          ...
          <p>
            Where personal data is transferred outside the EU/EEA, we rely
            on appropriate safeguards under the GDPR, such as the European
            Commission&rsquo;s{" "}
            <strong>Standard Contractual Clauses</strong> and the
            providers&rsquo; equivalent transfer mechanisms.
          </p>

          <h2 className="legal__h2">7. Blockchain anchoring — important notice</h2>
          <p>
            ...
            <strong>No personal data is ever written on-chain.</strong>{" "}
            Because public blockchains are immutable, any anchored data
            (which contains no personal data by design) is permanent and
            cannot be deleted.
          </p>
          ...
          <ul className="legal__list">
            ...
            <li>
              <strong>Encryption at rest:</strong> AES-256 across primary
              data stores (Atlas native, AWS KMS, Stripe-managed).
            </li>
            <li>
              <strong>Access control:</strong> Role-based access control
              (RBAC), multi-factor authentication (MFA), VPN for
              administrative access, scoped API keys and rate limiting.
            </li>
            <li>
              <strong>Data minimisation:</strong> Only data required for
              service delivery is collected and shared.
            </li>
            <li>
            ...
            <li>
              <strong>Geographic containment:</strong> Primary storage in
              the EU.
            </li>
          </ul>
          <p>
            These measures are described in our Information Security Policy
            and Data Lifecycle documentation and are maintained under our
          ...
          <p>
            We retain personal data only while there is a continued and
            valid reason to do so — for the duration of your relationship
            with us and as required to provide the Service, comply with
            legal and regulatory obligations, resolve disputes and enforce
            our agreements.
          </p>
          <p>
            When data is no longer necessary, it is securely deleted from
            cloud storage, databases and backups using secure deletion
            protocols (such as cryptographic erasure or overwriting), or
            anonymised where appropriate. Backups are purged according to
            our backup retention schedule. Policy documentation and certain
            records are retained for at least six years where required.
          </p>
          ...
          <ul className="legal__list">
            <li>
              <strong>Be informed</strong> about how your personal data is
              used;
            </li>
            <li>
          ...
          <p>
            ...
            agreements or where it would disrupt an active contracted
            service.
          </p>
          <p>
          ...
          <p>
            The Service is not directed to children below the age required
            to provide valid consent under applicable law, and we do not
            knowingly collect their personal data without appropriate
            authorisation.
          </p>
          ...
          <p>
            ...
            latest version will always be available at this URL, with the
            effective date shown above. Material changes will be
          ...
          <ul className="legal__list">
            ...
            <li>
              <strong>Controller:</strong> Unicorn Dimension, Lda (trading as
              Humanos), Portugal
            </li>
          </ul>
