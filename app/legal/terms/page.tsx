      ...
      <div className="wrap">
        <div className="legal__inner">
          ...
          <p className="legal__lede">
            ...
            <strong>Humanos Labs Inc.</strong>. These Terms govern your access
            to and use of the Humanos digital identity and verifiable
            credentials platform, including our websites, applications, public
          ...
          <p>
            ...
            and use of the <strong>Humanos</strong> digital identity and
          ...
          <p>
            ...
            , which is incorporated by reference. If you do not agree, you must
            not use the Service. If you use the Service on behalf of an
          ...
          <ul className="legal__list">
            ...
            <li>
              ...
              contracts with Humanos to use the platform, including to verify or
              manage the identities of its own end users.
            </li>
            <li>
              <strong>&ldquo;Verifiable Credential&rdquo;</strong> — a digitally
              signed, cryptographically verifiable attestation issued or managed
              through the Service.
            </li>
            <li>
              <strong>&ldquo;DID&rdquo;</strong> — a decentralised identifier
              associated with a credential.
            </li>
            <li>
              <strong>&ldquo;Authorized Agent&rdquo;</strong> — a person,
              partner or system authorised to access the Service (including via
              the public API) under a mandate or scoped permission, acting on
              behalf of a User or Customer.
            </li>
            <li>
          ...
          <p>
            To use the Service you must be of the age required to enter into a
            binding contract under applicable law and capable of forming a
            legally binding agreement. You agree to:
          </p>
          <ul className="legal__list">
            <li>
            ...
            <li>
              be responsible for all activity occurring under your account; and
            </li>
            <li>
          ...
          <p>
            ...
            are used in breach of these Terms, or that pose a security or legal
            risk.
          </p>
          ...
          <p>
            ...
            credentials, which may include identity verification (KYC), issuance
            and management of verifiable credentials and decentralised
            identifiers (DIDs), secure document storage, and anchoring of
            cryptographic credential references on a public blockchain. Specific
            features available to you depend on your account type and any
            separate agreement (such as an order form, subscription or Data
            Processing Agreement) between you and Humanos.
          </p>
          <p>
            We may modify, enhance or discontinue features of the Service. We
            will use reasonable efforts to give notice of material changes that
            adversely affect your use.
          </p>
          ...
          <p>
            Where the Service includes identity verification, you agree that:
          </p>
          <ul className="legal__list">
            <li>
              identity documents and biometric/facial images you submit will be
              processed through our verification provider for the purpose of
              verifying your identity;
            </li>
            <li>
              you will only submit documents and information that are genuine,
              lawful and relate to you (or to a person you are authorised to
              represent);
            </li>
            <li>
              verifiable credentials issued through the Service are
              cryptographically signed attestations, and their validity may
              depend on the issuer, the verification performed and the integrity
          ...
          <p>
            ...
            . Because public blockchains are immutable, anchored references are
          ...
          <p>
            ...
            through the public API or through a delegated mandate (where a User
            or Customer authorises another party or system to act on their
            behalf). If you grant or operate under such a mandate, you agree
            that:
          </p>
          <ul className="legal__list">
            <li>
              access must remain within the scope of the permissions or mandate
              granted;
            </li>
            <li>
              API access is authenticated and subject to API key authentication,
              role-based access control (RBAC), rate limiting and IP
              restrictions;
            </li>
            <li>
            ...
            <li>
              mandates may be time-limited, scoped and revocable, and we may
              enforce these limits technically.
            </li>
          </ul>
          <p>
          ...
          <ul className="legal__list">
            <li>
              ...
              or to submit forged, stolen or misrepresented identity
              information;
            </li>
            <li>
            ...
            <li>
              reverse engineer, decompile or extract source code, except to the
            ...
            <li>
              use the Service in a way that infringes the intellectual property,
              privacy or other rights of others.
            </li>
          </ul>
          <p>
            These obligations reflect our Acceptable Usage Policy. Violations
            may result in suspension or termination and may be reported to the
            relevant authorities.
          </p>

          <h2 className="legal__h2">8. Your Content and data</h2>
          <p>
            You retain all rights in the Content you submit. You grant Humanos a
            limited licence to host, process, transmit and store your Content
            solely as necessary to provide and secure the Service and as
            described in the{" "}
            <Link className="legal__link" href="/legal/privacy">
              Privacy Statement
            </Link>
          ...
          <p>
            You represent that you have all rights and, where required, consents
            necessary to submit your Content and to have it processed through
            the Service. Where Humanos processes personal data on behalf of a
            Customer, the Customer is the data controller and processing is
            governed by the applicable Data Processing Agreement.
          </p>
          <p>
            Personal data is handled in accordance with our Privacy Statement,
          ...
          <p>
            ...
            subscription plan or separate agreement. Payments are processed by
            our third-party payment processor (Stripe);{" "}
            <strong>
              card details are transmitted directly to the payment processor and
              do not pass through Humanos servers
            </strong>
            . Unless otherwise stated, fees are exclusive of applicable taxes,
            which are your responsibility. Late or failed payment may result in
          ...
          <p>
            ...
            Humanos (Humanos Labs Inc.) or its licensors and is protected by
            law. Except for the rights expressly granted to you to use the
            Service, no rights are transferred. &ldquo;Humanos&rdquo; and
            associated logos are our trademarks and may not be used without our
            prior written consent.
          </p>

          <h2 className="legal__h2">11. Third-party services</h2>
          <p>
            The Service relies on, and may integrate with, third-party providers
            (for example, our database, storage, authentication, payment,
            identity verification and OCR providers). Your use of such
            integrations may also be subject to the third parties&rsquo; own
            terms. We are not responsible for third-party services outside our
            control, but we contract with subprocessors under appropriate data
            protection terms as described in the Privacy Statement.
          </p>
          ...
          <p>
            ...
            and secure, including the technical and organisational measures
            described in our Information Security Policy and maintained under
            our ISO/IEC 27001:2022 certified Information Security Management
            System. However, the Service is provided on an &ldquo;as
            available&rdquo; basis and we do not guarantee uninterrupted or
            error-free operation. We may perform maintenance and may impose
            limits to protect the integrity and security of the Service.
          </p>
          ...
          <p>
            ...
            you breach these Terms, if required by law, or to protect the
          ...
          <p>
            ...
            Retention Policy, including secure deletion or anonymisation where
            applicable, subject to legal retention obligations. Provisions that
          ...
          <p>
            ...
            or that any verification result or credential will be accepted by
            any third party.
          </p>

          <h2 className="legal__h2">15. Limitation of liability</h2>
          <p>
            To the maximum extent permitted by law, Humanos and its officers,
            ...
            relating to your use of (or inability to use) the Service. Our total
            aggregate liability arising out of or relating to the Service will
            not exceed the amounts you paid to us for the Service in the twelve
            (12) months preceding the event giving rise to the liability, or,
            where no fees were paid, EUR 100.
          </p>
          <p>
            Nothing in these Terms excludes or limits liability that cannot be
            excluded or limited under applicable law (including liability for
            fraud, gross negligence, or death or personal injury caused by
            negligence).
          </p>

          <h2 className="legal__h2">16. Indemnification</h2>
          <p>
            You agree to indemnify and hold harmless Humanos from and against
            any claims, damages, liabilities and reasonable expenses (including
            legal fees) arising from your breach of these Terms, your misuse of
            the Service, your Content, or your violation of any law or
            third-party rights.
          </p>
          ...
          <p>
            ...
            be available at this URL, with the effective date shown above.
            Material changes will be communicated through the Service or by
            other appropriate means. Your continued use of the Service after
          ...
          <p>
            ...
            consumer protection rights, the courts of <strong>Portugal</strong>{" "}
            (Comarca de Lisboa) will have exclusive jurisdiction over any
          ...
          <ul className="legal__list">
            <li>
              ...
              Privacy Statement and any applicable order form, subscription or
              Data Processing Agreement, constitute the entire agreement between
              you and Humanos regarding the Service.
            </li>
            <li>
            ...
            <li>
              ...
              Service or to the contact details associated with your account.
            </li>
          </ul>
          ...
          <ul className="legal__list">
            ...
            <li>
              <strong>Provider:</strong> Humanos Labs Inc. (trading as Humanos),
              Portugal
            </li>
          </ul>
