    ...
    <section id="cross-system" data-theme="light">
      <div className="container-wide">
        <Reveal className="section-eyebrow">
          <span>03 · Cross-System Propagation</span>
        </Reveal>
        <Reveal>
          <div className="section-head">
            ...
            <p className="section-sub section-head-aside">
              ...
              and external systems — so every participant can verify what
        ...
        <SectionOutcome
          ...
          docs={{
            label: "VIA Protocol",
            href: "https://humanos.mintlify.app/via",
          }}
        />
        <Reveal delay={120} className="mobile-hide">
          <CrossSystemDiagram />
        </Reveal>
      </div>
    </section>
    ...
    const tick = (now) => {
      ...
      for (const f of flowsRef.current) {
        ...
        if (f.t > 1) {
          ...
          if (f.halo) f.halo.style.opacity = "0";
          continue;
        }
      ...
      if (flowLayerRef.current) {
        for (const f of flowsRef.current) {
          if (!f.el) {
            ...
            halo.setAttribute("filter", "url(#csGlow)");
            halo.setAttribute("fill", "#7978E9");
            const dot = document.createElementNS(ns, "circle");
            dot.setAttribute("r", "2.8");
            dot.setAttribute("fill", "#7978E9");
    ...
    <div ref={ref} className="arch-stage" style={{ padding: 0 }}>
      ...
      >
        ...
        <g>
          ...
          >
            identity-agnostic — humans &amp; agents, any provider
          </text>
  ...
  return (
    <g>
      <rect
        ...
        width={org.w}
        height={org.h}
        fill="rgba(75,73,202,0.04)"
        stroke="rgba(75,73,202,0.20)"
        strokeWidth="1"
        rx="6"
      />
      ...
      {org.systems.map((s, i) => (
        <g key={`s-${i}`}>
          ...
          <text
            ...
            fontFamily="JetBrains Mono, monospace"
          >
            {side === "left" ? "mandate.bind" : "proof.verify"}
          </text>
          <circle
      ...
      >
        DID · did:hum:org/{org.label.split(" ")[1].toLowerCase()}
      </text>
    </g>
  );
}
...
export function PolicySection() {
  return (
    <section id="policy">
      <div className="container-wide">
        <Reveal className="section-eyebrow">
          <span>07 · Policy Orchestration</span>
        </Reveal>
        <Reveal>
          <div className="section-head">
            ...
            <p className="section-sub section-head-aside">
              Contracts, approvals, and enterprise rules normalize into runtime
              authorization semantics — composable, signed, machine-verifiable.
            </p>
          </div>
        </Reveal>
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          {[
            {
              kind: "PDF",
              label: "Treasury Policy v2.4",
              sub: "34 pages · signed Q1",
            },
            {
              kind: "EMAIL",
              label: '"Approved up to €50k"',
              sub: "CFO · 2026-02-14",
            },
            {
              kind: "TICKET",
              label: "JIRA-7821 · approval",
              sub: "Finance Ops · closed",
            },
            {
              kind: "POLICY",
              label: "Counterparty allowlist",
              sub: "spreadsheet · 412 rows",
            },
            {
              kind: "DELEG.",
      ...
      >
        ...
        <svg width="40" height="60" viewBox="0 0 40 60">
          ...
          <path
            d="M 4 30 L 32 30 M 24 22 L 32 30 L 24 38"
            stroke="#7978E9"
            strokeWidth="1.5"
            fill="none"
          />
      ...
      >
        <span className="label-cap" style={{ color: "var(--c-execute)" }}>
          OUTPUT · RUNTIME AUTHORIZATION
        </span>
        <h3
          style={{
        ...
        >
          <div>
            <span style={{ color: "#7978E9" }}>policy</span>{" "}
            <span style={{ color: "#F4F3EF" }}>treasury.eu</span> {"{"}
          </div>
          <div style={{ paddingLeft: 16 }}>
            <span style={{ color: "var(--fg-on-dark-3)" }}>subject:</span>{" "}
            <span>did:hum:org/treasury-eu</span>
          </div>
          <div style={{ paddingLeft: 16 }}>
            <span style={{ color: "var(--fg-on-dark-3)" }}>action:</span>{" "}
            <span style={{ color: "#E4D8C8" }}>"transfer.execute"</span>
          </div>
          <div style={{ paddingLeft: 16 }}>
            <span style={{ color: "var(--fg-on-dark-3)" }}>scope:</span> {"{"}
          </div>
          <div style={{ paddingLeft: 32 }}>
            counterparty:{" "}
            <span style={{ color: "#E4D8C8" }}>"allowlist:CTLST-014"</span>
          </div>
          <div style={{ paddingLeft: 32 }}>
            region: <span style={{ color: "#E4D8C8" }}>"EU"</span>
          </div>
          <div style={{ paddingLeft: 16 }}>{"},"}</div>
          <div style={{ paddingLeft: 16 }}>
            <span style={{ color: "var(--fg-on-dark-3)" }}>constraints:</span>{" "}
            {"{"}
          </div>
          <div style={{ paddingLeft: 32 }}>
            amount: <span style={{ color: "#7DA0FA" }}>{"≤ €10,000"}</span>
          </div>
          <div style={{ paddingLeft: 32 }}>
            per_day: <span style={{ color: "#7DA0FA" }}>{"≤ €50,000"}</span>
          </div>
          <div style={{ paddingLeft: 16 }}>{"},"}</div>
          <div style={{ paddingLeft: 16 }}>
            <span style={{ color: "var(--fg-on-dark-3)" }}>delegation:</span>{" "}
            <span style={{ color: "#E4D8C8" }}>[cfo → ops → agent.v1]</span>
          </div>
          <div style={{ paddingLeft: 16 }}>
            <span style={{ color: "var(--fg-on-dark-3)" }}>valid_until:</span>{" "}
            <span>2026-06-01T23:59:59Z</span>
          </div>
          <div style={{ paddingLeft: 16 }}>
            <span style={{ color: "var(--fg-on-dark-3)" }}>signed_by:</span>{" "}
            <span style={{ color: "#7978E9" }}>Elena Ruiz · CFO ✓</span>
          </div>
          <div>{"}"}</div>
        </div>
        ...
        >
          {[
            ...
            >
              ...
              <span
                className="mono"
                style={{ fontSize: 11, color: "var(--fg-on-dark-2)" }}
              >
                {p.l}
              </span>
            </div>
      ...
      <div className="container-wide">
        ...
        <Reveal>
          <div className="section-head">
            ...
            <p className="section-sub section-head-aside">
              Humanos does not replace identity infrastructure. It standardizes
              authorization semantics around the identity you already have.
            </p>
          </div>
        </Reveal>
        ...
        <SectionOutcome
          ...
          docs={{
            label: "DIDs & VCs",
            href: "https://humanos.mintlify.app/identity",
          }}
        />
        <Reveal delay={120} className="mobile-hide">
          <IdentityDiagram />
    ...
    const tick = (now) => {
      ...
      for (const f of flowsRef.current) {
        ...
        if (f.el) {
          f.el.setAttribute("cx", x);
          f.el.setAttribute("cy", y);
          f.el.setAttribute("fill", color);
        }
        if (f.halo) {
          f.halo.setAttribute("cx", x);
          f.halo.setAttribute("cy", y);
          f.halo.setAttribute("fill", color);
        }
        survivors.push(f);
      }
      flowsRef.current = survivors;
      if (flowLayerRef.current) {
        for (const f of flowsRef.current) {
          if (!f.el) {
            ...
            halo.setAttribute("r", "6");
            halo.setAttribute("opacity", "0.22");
            halo.setAttribute("filter", "url(#idGlow)");
            halo.setAttribute("fill", "#7DA0FA");
            const dot = document.createElementNS(ns, "circle");
            dot.setAttribute("r", "2.6");
            dot.setAttribute("fill", "#7DA0FA");
            dot.setAttribute("style", "transition:opacity 400ms;");
            flowLayerRef.current.appendChild(halo);
            flowLayerRef.current.appendChild(dot);
            f.el = dot;
      ...
      >
        ...
        {providers.map((p, i) => (
          <g key={p.label}>
            ...
            <path
              d={`M 220 ${pY(i)} C 320 ${pY(i)}, ${W / 2 - 200} ${H / 2}, ${W / 2 - 100} ${H / 2}`}
              stroke="url(#idLine)"
              strokeWidth="1"
              fill="none"
            />
        ...
        <g>
          ...
          <text
            ...
            fontFamily="JetBrains Mono, monospace"
          >
            independent of identity source
          </text>
        </g>
        <path
          d={`M ${W / 2 + 100} ${H / 2} L ${W - 280} ${H / 2}`}
          stroke="rgba(75,73,202,0.30)"
          strokeWidth="1"
        />
...
export function RuntimeEnforcementSection() {
  return (
    <section id="enforcement">
      <div className="container-wide">
        <Reveal className="section-eyebrow">
          <span>09 · Runtime Enforcement</span>
        </Reveal>
        <Reveal>
          <div className="section-head">
            <h2 className="section-title">
        ...
        <SectionOutcome
          ...
          docs={{
            ...
            href: "https://humanos.mintlify.app/enforcement",
          }}
        />
        ...
        >
          {[
            {
              l: "Cross-system runtime verification",
              sub: "every action verifiable at the boundary",
            },
            {
              l: "Portable delegation across organizations",
              sub: "authority that travels with the actor",
            },
            {
              l: "External execution legitimacy before settlement",
              sub: "verify what was allowed, before money moves",
            },
            {
              l: "Runtime enforcement for autonomous systems",
              sub: "agents that cannot act outside their mandate",
            },
          ].map((c, i) => (
      ...
      <circle r="2.4" fill="#E4D8C8">
        {active && (
          <animateMotion
            dur="3.6s"
            repeatCount="indefinite"
            path="M 170 70 A 70 38 0 1 1 30 70 A 70 38 0 1 1 170 70"
          />
        )}
      </circle>
      <circle r="2.4" fill="#7DA0FA">
        {active && (
          <animateMotion
            dur="2.4s"
            repeatCount="indefinite"
            path="M 142 70 A 42 22 0 1 1 58 70 A 42 22 0 1 1 142 70"
          />
        )}
      </circle>
    </svg>
