    ...
    <section id="authorization" data-theme="light">
      <div className="container-wide">
        <Reveal className="section-eyebrow">
          <span>02 · Portable Authorization</span>
        </Reveal>
        <Reveal>
          <div className="section-head">
            <h2 className="section-title">Portable authorization.</h2>
            <p className="section-sub section-head-aside">
              Turn approvals, permissions, policies, contracts, and delegated
              authority into reusable runtime authorization — verifiable by any
              system that needs to act on them.
            </p>
          </div>
        </Reveal>
    ...
    >
      ...
      >
        ...
        >
          ...
          <span
            className="result-pill is-authorized"
            style={{ background: "rgba(75,73,202,0.10)" }}
          >
          ...
          {MANDATE_FIELDS.map((f, i) => (
            <div
              ...
              style={{
                ...
                transition:
                  "opacity 420ms var(--ease-standard), transform 420ms var(--ease-standard)",
              }}
            >
              <span
                className="mono"
      ...
      >
        ...
        >
          ...
          <span
            className="mono"
            style={{ fontSize: 11, color: "var(--fg-on-dark-3)" }}
          >
              ...
              return (
                <g key={t.label}>
                  ...
                  <rect
                    ...
                    stroke={
                      active ? "rgba(75,73,202,0.55)" : "rgba(244,243,239,0.10)"
                    }
                    strokeWidth="1"
                    rx="3"
...
function Stat({ n, l }) {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
      ...
      <span className="label-cap" style={{ fontSize: 10.5 }}>
        {l}
      </span>
    </div>
  );
...
export function RuntimeVerificationSection() {
  return (
    <section id="verification">
      <div className="container-wide">
        <Reveal className="section-eyebrow">
          <span>04 · Runtime Verification</span>
        </Reveal>
        <Reveal>
          <div className="section-head">
            <h2 className="section-title">Verify before execution.</h2>
            <p className="section-sub section-head-aside">
              Every action passes through six deterministic checks before it
              touches a system of record. No verification, no execution.
            </p>
          </div>
        </Reveal>
...
function VerificationEngine() {
  ...
  const resultMeta = {
    authorized: {
      color: "#4B49CA",
      label: "authorized",
      sub: "execution allowed",
    },
    rejected: { color: "#F3797E", label: "rejected", sub: "mandate revoked" },
    collect: {
      color: "#E4D8C8",
      label: "collect_missing",
      sub: "auth not in scope",
    },
    escalate: {
      color: "#FFC46B",
      label: "escalate",
      sub: "human signature required",
    },
  }[step.result];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="label-cap" style={{ fontSize: 10 }}>
            INCOMING
          </span>
          <div
            style={{
          ...
          >
            <span
              className="mono"
              style={{ fontSize: 14, color: "var(--c-pending)" }}
            >
              verify({step.src}.{step.action.split(" ")[0]})
            </span>
            <span style={{ color: "var(--fg-on-dark-2)", fontSize: 14 }}>
              {step.action}
            </span>
          </div>
          <div style={{ marginTop: 6 }}>
            <span
              className="mono"
              style={{ fontSize: 11.5, color: "var(--fg-on-dark-3)" }}
            >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          {VERIFY_CHECKS.map((c, i) => {
            const failed =
              ...
              step.checks.includes(c.k);
            const passed =
              (phase === "resolved" && !failed) ||
              (phase === "checking" && activeCheckIdx >= i);
            ...
            return (
              ...
              >
                ...
                <span
                  className="mono"
                  style={{ fontSize: 12.5, color: "var(--fg-on-dark-2)" }}
                >
                  {c.label}
                </span>
                <span
        ...
        <div
          style={{
            marginTop: 24,
            padding: "20px 24px",
            background: `linear-gradient(180deg, ${hexA(resultMeta.color, 0.1)}, transparent)`,
            border: `1px solid ${hexA(resultMeta.color, 0.4)}`,
            borderRadius: 4,
        ...
        >
          ...
          >
            ...
            <span style={{ fontSize: 13, color: "var(--fg-on-dark-3)" }}>
              {resultMeta.sub}
            </span>
          </div>
        </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          >
            {[
              ...
              >
                ...
                <span
                  className="mono"
                  style={{ fontSize: 11.5, color: "var(--fg-on-dark-2)" }}
                >
                  {r.label}
                </span>
              </div>
        ...
        >
          ...
          >
            ...
            <span
              className="mono"
              style={{ fontSize: 10, color: "var(--fg-on-dark-3)" }}
            >
              last 8 events
            </span>
          </div>
          <div style={{ display: "flex", flexDirection: "column" }}>
            {recent.length === 0 && (
              <span
                className="mono"
                style={{ fontSize: 11.5, color: "var(--fg-on-dark-4)" }}
              >
                awaiting traffic…
              </span>
            )}
      ...
      <div className="container-wide">
        ...
        <Reveal>
          <div className="section-head">
            ...
            <p className="section-sub section-head-aside">
              Most systems allow or deny. Humanos recovers execution legitimacy
              in real time — pausing an action, collecting what's missing,
...
const RECOVERY_STEPS = [
  {
    state: "executing",
    label: "transaction in flight",
    sub: "agent.v1 · transfer €52,000",
    tone: "execute",
  },
  {
    state: "paused",
    label: "paused — outside scope",
    sub: "mandate ceiling: €50,000",
    tone: "reject",
  },
  {
    state: "collect",
    label: "authorization request",
    sub: "requesting CFO approval",
    tone: "collect",
  },
  {
    state: "signed",
    label: "human signature received",
    sub: "Elena Ruiz · 2026-04-21T09:14:22Z",
    tone: "human",
  },
  {
    state: "updated",
    label: "mandate updated",
    sub: "ceiling raised to €60,000",
    tone: "verify",
  },
  {
    state: "resumed",
    label: "execution resumed",
    sub: "transfer completed · proof emitted",
    tone: "verify",
  },
];
    ...
    >
      ...
      >
        ...
        <div
          style={{
            ...
            background:
              "linear-gradient(90deg, var(--c-execute), var(--c-verify))",
            ...
            >
              <span
                style={{
                  ...
                  color: "#0A0A0B",
                  boxShadow: isActive
                    ? `0 0 0 6px ${hexA(color, 0.18)}, 0 0 18px ${hexA(color, 0.4)}`
                    : "none",
      ...
      >
        <div>
          ...
          >
            {RECOVERY_STEPS[activeStep].state.toUpperCase()}
          </span>
          <h3
            style={{
              fontSize: 28,
          ...
          >
            {RECOVERY_STEPS[activeStep].label}
          </h3>
          <p
            className="mono"
            style={{
        ...
        >
          <RecoveryLog
            ...
            color="#7978E9"
            l="exec.start"
            v="agent.v1 → transfer.execute"
          />
          <RecoveryLog
            active={activeStep >= 1}
            color="#F3797E"
            l="exec.pause"
            v="reason: scope.amount.exceeded"
          />
          <RecoveryLog
            active={activeStep >= 2}
            color="#E4D8C8"
            l="auth.request"
            v="signer: cfo · channel: secure_link"
          />
          <RecoveryLog
            active={activeStep >= 3}
            color="#E4D8C8"
            l="auth.signed"
            v="Elena Ruiz · 2026-04-21T09:14:22Z"
          />
          <RecoveryLog
            active={activeStep >= 4}
            color="#4B49CA"
            l="mandate.update"
            v="ceiling: €50,000 → €60,000"
          />
          <RecoveryLog
            active={activeStep >= 5}
            color="#4B49CA"
            l="exec.resume"
            v="proof.id: 0xPF·77E2 · authorized"
          />
        </div>
      </div>
    </div>
...
export function ReceiptsSection() {
  return (
    <section id="receipts">
      <div className="container-wide">
        <Reveal className="section-eyebrow">
          <span>06 · Execution Receipts</span>
        </Reveal>
        <Reveal>
          <div className="section-head">
        ...
        <SectionOutcome
          ...
          docs={{
            label: "Proofs (PoAI)",
            href: "https://humanos.mintlify.app/proofs",
          }}
        />
        <Reveal delay={120} className="mobile-hide">
          <ReceiptStage />
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p
          className="mono"
          style={{ fontSize: 12, color: "var(--fg-on-dark-3)", margin: 0 }}
        >
          ...
          <svg viewBox="0 0 460 360" style={{ width: "100%", height: "100%" }}>
            ...
            {verifiers.map((v, i) => {
              ...
              return (
                <g key={v.label}>
                  <path
                    d={`M 110 180 C 200 180, 260 ${y}, 350 ${y}`}
                    stroke={
                      emit ? "rgba(75,73,202,0.45)" : "rgba(75,73,202,0.10)"
                    }
                    strokeWidth="1"
                    fill="none"
