    ...
    <section id="integrations" data-theme="light">
      <div className="container-wide">
        ...
        <Reveal>
          <div className="section-head">
            ...
            <p className="section-sub section-head-aside">
              Humanos complements the systems you already run. The trust layer
              slots in alongside identity, applications, and external
              counterparties — without replacing any of them.
            </p>
          </div>
        </Reveal>
        ...
        <SectionOutcome
          ...
          docs={{
            label: "SDKs & API reference",
            href: "https://humanos.mintlify.app/sdk",
          }}
        />
        <Reveal delay={120}>
...
const CloudGlyph = () => (
  <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
    <path
      d="M7 18a4 4 0 010-8 6 6 0 0111-1 4 4 0 010 9H7z"
      stroke="currentColor"
      strokeWidth="1.4"
...
export function UseCasesSection() {
  ...
  return (
    <section id="use-cases">
      <div className="container-wide">
        <Reveal className="section-eyebrow">
          <span>11 · Real Execution Environments</span>
        </Reveal>
        <Reveal>
          <div className="section-head">
            <h2 className="section-title">Where it runs in production.</h2>
            <p className="section-sub section-head-aside">
              Organized by execution environment, not industry. Each setting
              shares the same primitive: actions that need to verify before they
              execute.
            </p>
          </div>
        </Reveal>
        <div
          className="uc-grid stage-light"
  ...
  return (
    ...
    >
      ...
      <text
        ...
        fontFamily="JetBrains Mono, monospace"
      >
        12,400 fills · all under mandate · €4.2M
      </text>
    </svg>
  );
}
      ...
      <g transform="translate(14, 50)">
        {[
          ...
          <g key={i} transform={`translate(${i * 50}, 0)`}>
            ...
            {i < 4 && (
              <path d="M 40 12 L 50 12" stroke="rgba(244,243,239,0.20)" />
            )}
          </g>
        ))}
      </g>
    ...
    <section className="final" ref={ref} id="final">
      ...
      >
        ...
        <Reveal>
          <span
            className="label-cap"
            style={{ display: "block", marginBottom: 32, textAlign: "center" }}
          >
        ...
        <Reveal delay={150}>
          <p>
            Today, authorization is trapped inside applications and workflows.
            Humanos separates it from systems and turns it into portable runtime
            infrastructure — reusable across organizations, APIs, agents, and
    ...
    >
      ...
      {[1, 2, 3, 4, 5].map((i) => (
        <circle
          ...
          fill="none"
          stroke={
            i % 2 === 0 ? "rgba(75,73,202,0.10)" : "rgba(121,120,233,0.06)"
          }
          strokeWidth="1"
        >
          {active && (
